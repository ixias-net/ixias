...
trait SlickRelationalTypesComponent[P <: JdbcProfile] {
  ...
  trait ImplicitColumnTypes {
    implicit def jodaDateTimeColumnType      = columnTypes.jodaDateTime.Type
    implicit def jodaDateTimeGetResult       = columnTypes.jodaDateTime.Get
    implicit def jodaDateTimeGetResultOpt    = columnTypes.jodaDateTime.GetOpt
    implicit def jodaDateTimeSetParameter    = columnTypes.jodaDateTime.Set
    implicit def jodaDateTimeSetParameterOpt = columnTypes.jodaDateTime.SetOpt
  }
}
