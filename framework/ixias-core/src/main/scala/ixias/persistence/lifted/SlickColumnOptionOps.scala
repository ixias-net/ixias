...
final case class SlickColumnOptionsExtension[A <: P#ColumnOptions](self: A) {
  ...
  val Utf8BinChar8    = self.SqlType("VARCHAR(8)   CHARACTER SET utf8  COLLATE utf8mb4_bin")
  val Utf8BinChar16   = self.SqlType("VARCHAR(16)  CHARACTER SET utf8  COLLATE utf8mb4_bin")
  val Utf8BinChar32   = self.SqlType("VARCHAR(32)  CHARACTER SET utf8  COLLATE utf8mb4_bin")
  val Utf8BinChar64   = self.SqlType("VARCHAR(64)  CHARACTER SET utf8  COLLATE utf8mb4_bin")
  val Utf8BinChar128  = self.SqlType("VARCHAR(128) CHARACTER SET utf8  COLLATE utf8mb4_bin")
  val Utf8BinChar255  = self.SqlType("VARCHAR(255) CHARACTER SET utf8  COLLATE utf8mb4_bin")
